...
Claude was great for assisting me throughout this project. I was able to input all my desired ideas and suggestions, and it gave me downloadable files ready for Github upload. I edited said code to match the style of what I was looking for (adding button on HTML and fixing design on CSS). When I was having trouble with my API key, it suggested I go to Vercel and connect my repository through there. I honestly had no AI troubles, my only difficulty came from the API key. Professor Bierman had to create one for me, and I was then able to see the Vibe-Based Playlist Generator in action. 
